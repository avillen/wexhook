defmodule WexhookWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WexhookWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WexhookWeb.Gettext, "errors", msg, opts)
    end
  end
