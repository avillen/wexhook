defmodule Wexhook.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule WexhookWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :wexhook

       ...

       plug PromEx.Plug, prom_ex_module: Wexhook.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: WexhookWeb.Router, endpoint: WexhookWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:wexhook, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
